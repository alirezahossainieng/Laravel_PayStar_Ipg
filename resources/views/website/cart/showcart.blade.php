...
<div class="card">
    ...
    <div class="card-body">
            ...
            @foreach ($cart->products as $key=>$item)
                <tr>
                    ...
                    <td >
                        ...
                        {!! Form::text('qty', $value=$item['count'], ['class'=>'form-control']) !!}
                    ...
                    <td>
                        ...
                        {!! Form::open(['route'=>['removecart',$item['product']->id] ,'method'=>'delete']) !!}
        ...
        {!! Form::text('address', $value=$cart->address, ['class'=>'form-control']) !!}
